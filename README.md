...
tasks/<task-dir>/context-pack/runtime/phase<N>-contract.json
tasks/<task-dir>/context-pack/runtime/phase<N>-checklist.md
...
tasks/<task-dir>/context-pack/runtime/phase<N>-evidence.json
tasks/<task-dir>/context-pack/runtime/phase<N>-reconciliation.json
tasks/<task-dir>/context-pack/runtime/phase<N>-reconciliation.md
tasks/<task-dir>/context-pack/runtime/phase<N>-gate.json
...
Codex가 "완료했습니다"라고 말해도 충분하지 않습니다. runner가 확인 명령을 실행하고, 필요한 파일을 확인하고, `phase-gate.json`을 통과시킨 뒤 `phase-result.json`을 만들었을 때 완료로 봅니다.
