...
신뢰도: 0-100
핵심 근거: <한 문장>
점수 부족 지점: <100점 미만이면 부족한 체크리스트 항목과 이유. 100점이면 "없음">

상세:

* 증거: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 가치: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 대안: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 자동화: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 긴급성: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 스코프: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
...
* 반복성: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 실패 비용: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 대안: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 자동화: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 재현성: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
* 스코프: <충족 | 부족> - <판단 근거와 부족하면 필요한 보강>
